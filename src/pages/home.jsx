...
const Home = () => {
    ...
    return (
      ...
      <div id="home" className=' flex flex-col items-center justify-center pt-[100px]'>
          ...
          <div className='flex flex-col items-center pt-3' data-aos='fade-down' data-aos-duration='1600' data-aos-delay='700'>
          ...
          <div className='text-center text-md py-2 text-[30px] sm:text-[36px] md:text-[48px] lg:text-[54px] xl:text-[66px] 2xl:text-[84px] leading-[30px] sm:leading-[36px] md:leading-[48px] lg:leading-[60px] 2xl:leading-[84px] font-semibold'>
            <p className='text-tertiary'data-aos='fade-down' data-aos-duration='1700' data-aos-delay='900'>FULL STACK</p>
            <p data-aos='fade-down' data-aos-duration='1700' data-aos-delay='1000'>WEB DEVELOPER</p>
          </div>
  
          <div className='w-[280px] sm:w-[400px] md:w-[450px] lg:w-[560px] 2xl:w-[650px] text-xs sm:text-sm md:text-md lg:text-base 2xl:text-xl text-center text-text-color' data-aos='fade-down' data-aos-duration='1800' data-aos-delay='1200'>
          ...
          <div className='flex flex-col sm:flex-row items-center mt-7 gap-5' data-aos='fade-up' data-aos-duration='1900' data-aos-delay='1400'>
            <ShowProject />
            <DiscoverMore />
          </div>
